# Get given trajectory and store
...
execute as @e[tag=_dummy] if score @s anim_movement.traj_id = #player anim_movement.traj_id run data merge entity @s {CustomNameVisible:0b}
