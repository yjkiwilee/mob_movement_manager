...
give @s minecraft:paper{ControlID:"toggle_debug_elem",controlItem:1b,display:{Name:'"Toggle labels & armor stands visibility"'},Enchantments:[{lvl:1,id:"minecraft:unbreaking"}],HideFlags:1b} 1
give @s minecraft:blaze_rod{ControlID:"select_dummy",controlItem:1b,display:{Name:'"Select dummy"'},Enchantments:[{lvl:1,id:"minecraft:unbreaking"}],HideFlags:1b} 1
