...
$execute if score #traj anim_movement.recording.debug_visibility matches 0 run function anim_movement:show_debug_elem_withid {id:$(id)}
# Call hide_debug_elem if status is 1
$execute if score #traj anim_movement.recording.debug_visibility matches 1 run function anim_movement:hide_debug_elem_withid {id:$(id)}
